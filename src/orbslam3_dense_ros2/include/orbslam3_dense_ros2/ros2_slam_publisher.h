...
private:
    ...
    double map_pointcloud_rate_hz_;
    std::string camera_frame_;
    std::string ground_frame_;
    std::string vehicle_frame_;
    std::string target_map_frame_;
    ...
    sensor_msgs::msg::PointCloud2 PCLToROS(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr& pcl_cloud,
                                           const std::string& frame_id);
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr FilterPointCloud(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr& input_cloud) const;
    pcl::PointCloud<pcl::PointXYZI>::Ptr ConvertToIntensityCloud(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr& input_cloud) const;
    pcl::PointCloud<pcl::PointXYZI>::Ptr TransformToTargetFrame(const pcl::PointCloud<pcl::PointXYZI>::Ptr& cloud, const std::string& source_frame);
