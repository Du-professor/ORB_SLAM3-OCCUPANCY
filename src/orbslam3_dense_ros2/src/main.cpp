...
public:
    ...
    {
    // Default parameters (will be overridden by ROS2 launch parameters)
    std::string voc_file = "/home/test/robot_ws/install/orbslam3_dense_ros2/share/orbslam3_dense_ros2/orb_slam3/Vocabulary/ORBvoc.txt.bin";
    std::string settings_file = "/home/test/robot_ws/install/orbslam3_dense_ros2/share/orbslam3_dense_ros2/orb_slam3/config/RGB-D/RealSense_D435i.yaml";
...
int main(int argc, char** argv)
{
    ...
    try {
        // Create and run the node (do not rely on raw argv for parameters)
